                            ...
                            <Card>
                                ...
                                <form onSubmit={handleSmsAnalyze}>
                                    ...
                                    <CardFooter className="flex-col items-start gap-4">
                                        <Button type="submit" disabled={isAnalyzingSms || !smsFormData.message || !smsFormData.senderId}>
                    ...
                    <div className="grid gap-6 md:grid-cols-2">
                        <Card>
                            ...
                            <form onSubmit={handleEmailAnalyze}>
                                ...
                                <CardFooter>
                                    <Button type="submit" disabled={isAnalyzingEmail || !emailFormData.body}>
                                        {isAnalyzingEmail && <Loader className="mr-2 h-4 w-4 animate-spin" />}
                                        Analyze Email
                                    </Button>
                                </CardFooter>
                            </form>
                    ...
                    <div className="grid gap-6 md:grid-cols-2">
                        <Card>
                            ...
                            <form onSubmit={handleWhatsappAnalyze}>
                                ...
                                <CardFooter>
                                    <Button type="submit" disabled={isAnalyzingWhatsapp || !whatsappFormData.message}>
                                        {isAnalyzingWhatsapp && <Loader className="mr-2 h-4 w-4 animate-spin" />}
                                        Analyze Message
                                    </Button>
                                </CardFooter>
                            </form>

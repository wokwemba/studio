...
import { Loader, Send, ClipboardList } from 'lucide-react';
...
const requestType = "Incident Response Tabletop Exercise";
        ...
        <div className="container mx-auto p-4 sm:p-6 lg:p-8">
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        A discussion-based session where team members walk through a simulated incident.
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <DynamicForm

...
export function CorporateAdminDashboard() {
  ...
  const userMetrics = useMemo(() => {
    ...
    return {
      ...
      admins: (rolesCount['Admin'] || 0) + (rolesCount['SuperAdmin'] || 0),
    };
  }, [users, roles]);
        ...
        <div className="lg:col-span-2">
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Here you can manage users, campaigns, and settings for your organization.</CardDescription>
                </CardHeader>
                <CardContent>
                    <p>This is the main dashboard for your tenant. Use the navigation above to access different sections.</p>
                </CardContent>
            </Card>
        </div>
        <AiInsights />

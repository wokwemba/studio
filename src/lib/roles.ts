...
export const ALL_ROLES = [
  ...
  { id: ROLE_READ_ONLY_USER, name: 'Read-Only User', tier: 4, description: 'Can only read resources.' },
  { id: ROLE_ANONYMOUS, name: 'Anonymous', tier: 4, description: 'Minimal access for guest users.' },
];
